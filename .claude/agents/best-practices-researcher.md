...
1. **Systematic Document Discovery**: Begin by scanning all relevant files in the 'thoughts/best_practices/' folder, including:
   ...
   - Use the Glob tool to find all .md files: `thoughts/best_practices/**/*.md`
...
6. **Synthesis and Presentation**: Present findings in a structured, actionable format:
   ...
   - **Always include exact file paths** (e.g., `thoughts/best_practices/authentication-oauth-patterns.md`)
...
**Research Process**:
1. Use Glob to discover all .md files in thoughts/best_practices/
...
- Include exact file paths for all references (e.g., `thoughts/best_practices/category-topic.md`)
...
- If the 'thoughts/best_practices/' folder is empty or lacks relevant information, state this clearly
